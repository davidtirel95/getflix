...
=======
                ...
                <h5 class="text-center">Hello <?php echo $_SESSION['user']['first_name']; ?>, welcome in your profile</h5>
                <p class="text-center">First name : <?php echo $_SESSION['user']['first_name']; ?> </p>
                <p class="text-center">Last name : <?php echo $_SESSION['user']['last_name']; ?> </p>
                <p class="text-center">email : <?php echo $_SESSION['user']['email']; ?> </p>
    ...
    <div class="container" id="changePass">
        <div class="row">
            <div class="col-xs-12 col-sm-10 col-md-6 col-lg-4 mx-auto justify-content-center">
                <h5 class="text-center">Change your profile's password</h5>
                <!-- message d'erreur -->
                <?php
                ...
                <form method="post" action="<?php echo htmlspecialchars(
                    ...
                    <div class="mb-3">
                        <input type="password" name="newpassword" class="form-control form-control-lg" id="newpassword" placeholder="new password" maxlength="13" minlength="8" required>
                    </div>
                    <div class="mb-3">
                        <input type="password" name="newpassword2" class="form-control form-control-lg" id="newpassword2" placeholder="repeat new password" maxlength="12" minlength="8" required>
                ...
                <div class="border-top border-danger border-top-2 pb-4">
                    <br>
                    <h5 class="text-center">Change your details here</h5>
                    <br>
                    <!-- mesage2 user -->
                    ...
                    <form method="post" action="<?php echo htmlspecialchars(
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="first_name" class="form-control form-control-lg" id="first_name" placeholder="first name" minlength="1" maxlength="40" value="<?php echo $_SESSION['user']['first_name']; ?>" required>
                        </div>
                        <div class="mb-3">
                            <div class="form-text text-light">last name:</div>
                            <input type="text" name="last_name" class="form-control form-control-lg" id="last_name" placeholder="last name" minlength="1" maxlength="40" value="<?php echo $_SESSION['user']['last_name']; ?>" required>
                        </div>
