...
<<<<<<< HEAD
                ...
                <li class="nav-item mx-4 my-auto">
                    <button class="m-1 btn btn-danger px-3"><a class="nav-link  m-0 p-0"
                            href="./register.php">Login</a></button>
                </li>
                <?php else: ?>
                <li class="nav-item mx-4 my-auto">
                    <button class="m-1 btn btn-dark boder border-1 border-danger px-3" type="submit"><a
                            class="nav-link m-0 p-0" href="./deconnect.php">Logout</a></button>
                </li>
                <?php endif; ?>
...
>>>>>>> ed33f128b935e5439ae78b800b0fe5d9236a6a2b
            ...
            <form action="./main.php" method="get" class="d-flex mx-4">
                <input name="search2" value=""
                    class="m-1 form-control bg-light border border-1 border-danger rounded-pill bg-opacity-10 text-light ps-3 ps-2"
