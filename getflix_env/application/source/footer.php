<footer class="bg-dark text-center text-white mt-4">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mx-auto justify-content-center">
                <div class="justify-content-center border-top border-1 border-light">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="text-center p-3 bg-dark">
        © 2021 Copyright:
        <a class="text-white" href="https://github.com/ClaraCliment"><strong class="text-danger">Clara Climent </strong> |
            <a class="text-white" href="https://github.com/gysenlionel"> <strong class="text-danger">Lionel Gysen </strong> |<a class="text-white" href="https://github.com/davidtirel95"> <strong class="text-danger">David Tirel</strong> | <a class="text-white" href="https://github.com/MorganeFanon"><strong class="text-danger">Morgane Fanon</strong></a>
    </div>
    <!-- Copyright -->

    <p class="text-center p-3 bg-dark fs-6">This webpage is an exercice done during BeCode's training. It is not a real movie platform.
    <p>
</footer>